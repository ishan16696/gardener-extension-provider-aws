...
func ValidateBackupBucketConfig(backupBucketConfig *apisaws.BackupBucketConfig, fldPath *field.Path) field.ErrorList {
	...
	// AWS S3 immutability period can only be set in days and can't be less than 1 day i.e 24h.
	...
	// AWS S3 immutability period can only be set in days and must be a positive integer.
