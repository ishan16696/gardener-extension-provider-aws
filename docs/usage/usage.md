...
The Gardener extension provider for AWS supports creating (and migrating already existing buckets if enabled) to use [object lock](https://aws.amazon.com/s3/features/object-lock/) feature provided by storage provider AWS S3.
